<template>
    <div>
        ...
        <el-table border style="width:100%" :data="records">
            ...
            <el-table-column label="默认图片" width="80">
                <template slot-scope="{row,$index}">
                    <img :src="row.skuDefaultImg" style="width:80p;height:80px">
                </template>
            </el-table-column>
            ...
            <el-table-column prop="prop" label="操作" width="width">
                <template slot-scope="{row,$index}">
                    <el-button type="info" icon="el-icon-sort-down" size="mini" v-if="row.isSale == 0"
        ...
        <!-- 分页器 -->
        <el-pagination style="text-align:center" :total="total" :current-page="page" :page-sizes="[3, 5, 7]"
            :page-size="limit" layout="prev,pager,next,jumper,->,sizes,total" @current-change="getSkuList"
        ...
        <el-drawer :visible.sync="drawer" :show-close="false" size="50%">
            ...
            <el-row>
                ...
                <el-col :span="16">
                    <el-carousel height="600px" border>
...
export default {
    ...
    methods: {
        ...
        edit() {
            this.$message({ type: 'info', message: '正在开发，请等待' })
        },
