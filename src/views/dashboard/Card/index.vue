<template>
    <div>
        <el-row :gutter="10">
                ...
                <el-card>
                    <Detail title="总销售额" count="￥126560">
                        <template slot="charts">
                            <span>周同比&nbsp;&nbsp;56.6% <svg t="1681912995831" class="icon" viewBox="0 0 1024 1024"
                                    version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4657" width="16" height="16">
                                    <path
                                    ...
                                    <path
                                        ...
                                        fill="#1afa29" p-id="4667"></path>
                                </svg></span>
                            &nbsp;
                            <span>日同比&nbsp;&nbsp;11.6% <svg t="1681913188666" class="icon" viewBox="0 0 1024 1024"
                                    version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5817" width="16" height="16">
                                    <path
                                        d="M252.484267 566.749867h11.776v16.6912h-11.776zM815.684267 566.8352h10.461866v16.9984h-10.461866z"
                                        fill="#d81e06" p-id="5818"></path>
                                    <path
                                    ...
                                    <path d="M654.523733 591.854933h-1.5872l20.48-409.6H405.1968l20.48 409.6" fill="#d81e06"
                                        p-id="5822"></path>
                                    <path d="M654.523733 593.5616h-1.5872l20.48-409.6H405.1968l20.48 409.6" fill="#d81e06"
                                        p-id="5823"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        fill="#d81e06" p-id="5829"></path>
                                </svg></span>
                        </template>
                        <template slot="footer">
                            <span>日销售额￥ 12123</span>
                        </template>
                    </Detail>
                </el-card>
            </el-col>
            ...
            <el-col :span="6">
                <el-card>
                    <Detail title="支付笔数" count="￥126560">
                        <template slot="charts">
                            <barCharts></barCharts>
                        </template>
                        <template slot="footer">
            ...
            <el-col :span="6">
                <el-card>
                    <Detail title="运营活动效果" count="￥126560">
                        <template slot="charts">
